...
impl ToVk for VertexAttributeFormat {
    ...
    fn to_vk(self) -> Self::Target {
        match self {
            ...
            VertexAttributeFormat::FloatUnorm => vk::Format::R8_UNORM,
            VertexAttributeFormat::Float2Unorm => vk::Format::R8G8_UNORM,
            VertexAttributeFormat::Float3Unorm => vk::Format::R8G8B8_UNORM,
            VertexAttributeFormat::Float4Unorm => vk::Format::R8G8B8A8_UNORM,
